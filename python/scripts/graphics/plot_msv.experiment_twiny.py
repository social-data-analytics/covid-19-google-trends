...
fig, ax = plt.subplots(nrows=1, ncols=22, sharex=True, figsize=(15, 10))
...
for index, keyword in enumerate(keyword_query_results):
    ...
    sns.lineplot(x="date", y="msv", data=msv_df, ax=current_ax, alpha=0.5, color=f"C{index}")
...
plt.savefig('D:/OneDrive - HKUST/LongCOVIDCode/graphs/20240403-LongCV-MSVs.TwinX.pdf', bbox_inches='tight')
plt.show()