...
reference_df = pd.read_pickle("D:/OneDrive - HKUST/LongCOVIDCode/data/msv/.g.11qm6vy88k.pkl").query('date >= \'2021-10-01\'').reset_index()
...
# with PdfPages('./graphs/20240423-LongCV-MSVs.1st.pdf') as pdf:
    for index, tag in enumerate(keyword_query_results[1:]):
        ...
        msv_df = msv_df.query('date >= \'2021-10-01\'').reset_index()
        ...
        ax1.set_xlim(left=date.fromisoformat('2021-11-01'), right=date.fromisoformat('2022-02-25'))
        plt.tight_layout()
